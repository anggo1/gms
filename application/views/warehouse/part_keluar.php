								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<div class="input-group date" id="reservationdate" data-target-input="nearest">
											...
											<input type="text" name="tgl_keluar" id="tgl_keluar" value="" class="form-control tgl_po datetimepicker" data-toggle="datetimepicker" data-target=".tgl_po" data-format="yyy-mm-dd" required>
									...
									<div class="col-sm-4">
										<input type="text" name="kode_pesan" id="kode_pesan" class="form-control" placeholder="Penanggung Jawab">
									</div>
								</div>
								<div class="form-group row">
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<div class="icheck-red d-inline">
											<input type="radio" name="status_keluar" onClick="nonSpk()" value="N" id="radioSuccess6" checked>
											<label for="radioSuccess6"> Non SPK
											</label>

										</div>&nbsp;&nbsp;
										<div class="icheck-green d-inline">
											<input type="radio" name="status_keluar" onClick="Spk()" value="Y" id="radioSuccess5">
