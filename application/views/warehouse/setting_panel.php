          ...
          <div class="col-lg-3">
            <div class="card ">
              <div class="modal-content">
                ...
                <h3 class="card-title"><i class="fa fa-user-graduate text-blue"></i> &nbsp; Satuan Barang</h3>
                <div class="text-right">                  
                    <button type="button" class="btn btn-sm btn-outline-primary"  data-toggle="modal" data-target="#tambah-satuan" title="Add Data"><i class="fas fa-plus"></i> Add Satuan</button>
                </div>
                </div>
                <div class="col-12 ">
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped  table-bordered table-hover dt-responsive nowrap" id="list-satuan">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th>Kode</th>
            ...
            <div class="card ">
              <div class="modal-content">
                <div class="card-header card-blue card-outline">
                <h3 class="card-title"><i class="fa fa-user-shield text-blue"></i> &nbsp; Kategori Barang</h3>
                <div class="text-right">                  
                  <button type="button" class="btn btn-sm btn-outline-primary"  data-toggle="modal" data-target="#tambah-kategori" title="Add Data"><i class="fas fa-plus"></i> Add Kategori</button>
                </div>
                </div>
                <div class="col-12 ">
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped  table-bordered table-hover dt-responsive nowrap" id="list-kategori">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th>Nama Kategori</th>
            ...
            <div class="card ">
              <div class="modal-content">
                <div class="card-header card-blue card-outline">
                <h3 class="card-title"><i class="fa fa-user-tie text-blue"></i> &nbsp; Tipe Mesin</h3>
                <div class="text-right">                  
                  <button type="button" class="btn btn-sm btn-outline-primary"  data-toggle="modal" data-target="#tambah-mesin" title="Add Data"><i class="fas fa-plus"></i> Add Mesin</button>
                </div>
                </div>
                <div class="col-12 ">
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped  table-bordered table-hover dt-responsive nowrap" id="list-type">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th>Nama Mesin</th>
            ...
            <div class="card ">
              <div class="modal-content">
                ...
                <div class="text-right">                  
                  <button type="button" class="btn btn-sm btn-outline-primary"  data-toggle="modal" data-target="#tambah-supplier" title="Add Data"><i class="fas fa-plus"></i> Add Supplier</button>
                </div>
                </div>
                <div class="col-12 ">
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped  table-bordered table-hover dt-responsive nowrap" id="list-supplier">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th>Nama Supplier</th>
...
<script type="text/javascript">
    ...
    var MyTable = $('#list-satuan').dataTable({
		"responsive": true,
		"paging": true,
		"lengthChange": true,
		"searching": true,
