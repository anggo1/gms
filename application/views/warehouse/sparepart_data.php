                ...
                <div class="card">
                    <div class="card-header bg-light">
                        ...
                        <div class="text-right">
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="add_sparepart()"
                                title="Add Data"><i class="fas fa-plus"></i> Add</button>
                            <a href="<?php echo base_url('Sparepart/download'); ?>" type="button"
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="card card-danger card-outline">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-sm-3 col-form-label">Kelompok</label>
                                                                    <div class="col-sm-9">
                                                                        <input type="text" name="alamat" id="alamat"
                                                                            class="form-control">
                                                                    </div>
