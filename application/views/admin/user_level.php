    ...
    "sEmptyTable": "Data menu Belum Ada"
        ...
        "ajax": {
         ...
         { 
            ...
            "targets" : [1],
            "render" : function (data, type, row) {
              return "<a class=\"btn btn-xs btn-info\" href=\"javascript:void(0)\" title=\"Hak Akses Menu\" onclick=\"aksesmenu("+row[1]+")\">Hak Akses Menu</a> <a class=\"btn btn-xs btn-success\" href=\"javascript:void(0)\" title=\"Hak Akses Submenu\" onclick=\"aksessubmenu("+row[1]+")\">Hak Akses Submenu</a>";
            }
