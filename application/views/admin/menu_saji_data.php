      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header bg-light">
            <h3 class="card-title"><i class="fa fa-list text-blue"></i> Data Menu Saji</h3>
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <table id="tabelmenusaji" class="table table-bordered table-striped table-hover">
              <thead>
                <tr class="bg-info">
                  <th>Gambar</th>
                  <th>Nama</th>
...
$(document).ready(function() {
    ...
    table =$("#tabelmenusaji").DataTable({
      ...
      "language": {
        ...
        "ajax": {
          "url": "<?php echo site_url('Menu_saji/ajax_list')?>",
          "type": "POST"
        },
