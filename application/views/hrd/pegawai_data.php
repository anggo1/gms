...
function edit_pegawai(nip) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var x = '';
            var arr1 = data.tgl_masuk.split('-');
            var x = arr1[2] + "-" + arr1[1] + "-" + arr1[0];
            var y = '';
            var arr2 = data.tgl_lahir.split('-');
            var y = arr2[2] + "-" + arr2[1] + "-" + arr2[0];
            $('[name="tgl_masuk"]').val(x);
            $('[name="tempat_lahir"]').val(data.tempat_lahir);
            $('[name="tgl_lahir"]').val(y);
                                            ...
                                            <div class="col-12 ">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="card card-danger card-outline">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="">
                                                                    <label class="control-label">Departement <span
                                                                            class="required"> *</span></label>
                                                                ...
                                                                <div class="">
                                                                    <label class="control-label">Posisi / Jabatan <span
                                                                            class="required"> *</span></label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="field-1" class="control-label">Tanggal
                                                                        Masuk </label>
                                                                    <div class="input-group date" id="tgl1"
                                                                        data-target-input="nearest">

                                                                        <input type="text" name="tgl_masuk" id="tgl1"
                                                                            value=""
                                                                    ...
                                                                    <div class="">
                                                                        <label class="control-label">Status
                                                                            Kerja</label>
                                                                        <input type="text" name="status_kerja" value=""
                                                                            class="form-control">
                                                                    </div>
                                                                    <div class="">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="card card-info card-outline">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="">
                                                                    <label class="control-label">Agama <span
                                                                            class="required"> *</span></label>
                                                                ...
                                                                <div class="">
                                                                    <label class="control-label">Status Perkawinan
                                                                    </label>
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    <button class="btn btn-danger" data-dismiss="modal"
                                                        onclick="batal()" aria-hidden="true">Tutup</button>
                                                    <button class="btn btn-primary" id="btnSave" onclick="save()"><span
