...
class Mod_settingwh extends CI_Model
{
	...
	{
		$sql = "UPDATE tbl_wh_type_mesin SET type_mesin='" . $data['type'] . "' WHERE id_type='" . $data['id_type'] . "'";
	...
	{
		$sql = "INSERT INTO tbl_wh_supplier VALUES
		('','" . $data['kode_supplier'] . "','" . $data['nama_supplier'] . "','" . $data['alamat'] . "','" . $data['no_tlp'] . "','" . $data['tlp_person'] . "')";
